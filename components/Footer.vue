<template>
  <!-- <div class="bg-[#f3f5f6] text-[#1b3164] border-t-2 border-[#e0e1e2]"> -->
  <div class="bg-[#f3f5f6] text-[#124e86] border-t-2 border-[#e0e1e2] border-b-4">
    <div class="flex flex-col items-center justify-center gap-2 md:gap-6 max-w-xl mx-auto px-4 py-8 md:py-16" data-aos="fade-up">
